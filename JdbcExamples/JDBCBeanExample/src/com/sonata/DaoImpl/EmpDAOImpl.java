...
public class EmpDAOImpl implements EmpDao{
	...
	public int save (Object object) {
		try {
			...
			PreparedStatement cs = db.getConnection().prepareStatement
					("insert into SELECT * FROM mgvivek.employee;SELECT * FROM mgvivek.employee;(?,?,?,)");
	...
	public List<Employee> getData() {
		...
		try {
			PreparedStatement cs1 = db.getConnection().prepareStatement("SELECT * FROM mgvivek.employee");
